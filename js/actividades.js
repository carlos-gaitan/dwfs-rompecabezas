...
// objetosUno
console.log('uno dos tres ... probando');
var Jabali = {
  color: 'marron',
  altura: '1',
  peso: '45'
...
var Pelicula = {
  ...
  actoresPrincipales: ['John Travolta', 'Hugh Jackman', 'Halle Berry']
};
// objetosSeis
var MaquinaDeCafe = {
  marca: 'melita',
  ...
  prepararCafe: function() {
      console.log('info: preparando cafe!');
  }
};

// objetossiete
var Heladeria = {
  gustosDeHelado: ['Banana', 'Frutilla', 'Chocolate blanco', 'Dulce de leche'],
  nombre: 'Heladeria elcharly',
  precio: 125,
  lanzarCampana: function() {
    console.log('Precio/Kilo: ' + this.precio);
  },
};

// objetoOcho
var MensajeroDeAlertas = {
  tipoDeAlertas:['Error', 'Aviso', 'Bienvenida'],
  alertasMostradas: 0,
  escribirTexto : function(texto) {
